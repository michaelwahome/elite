...
public class UpdateTotal extends JFrame{
    ...
    public UpdateTotal(String user) {
        super("Update Total Fees");
        this.setContentPane(pnlUpdateTotal);
        ...
        try{
            ...
            while(rs6.next()){
                String data[]= {String.valueOf(rs6.getInt("admissionNo")), rs6.getString("fName"), rs6.getString("lName"), String.valueOf(rs6.getInt("totalFees"))};
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    if (!(rs.next())) {
                        ...
                        int confirmed = JOptionPane.showConfirmDialog(null,
                                "Are you sure you want to update the total expected fees of the student?", "Confirmation",
                                JOptionPane.YES_NO_OPTION);
                        if (confirmed == JOptionPane.YES_OPTION) {
                            try {
                                String s = "UPDATE tbl_students SET totalFees = ? WHERE admissionNo = ?";
                                PreparedStatement ps = connection.prepareStatement(s);
                                ps.setInt(1, Integer.parseInt(txtTotal.getText()));
                                ...
                                JOptionPane.showMessageDialog(null,"Do not leave the Total Fees field blank","Empty Field",JOptionPane.ERROR_MESSAGE);
                            }
                        }
                    }
                    ps1.close();
